package com.example.application.views.httpsharwinlantorosorfgd;


import com.example.application.views.MainLayout;
import com.example.application.views.httpsharwinlantorosorfgd.ServiceHealth.Status;
...
@PageTitle("Https://harwin Lantoroso Rf Gd")
@Route(value = "https://harwin-lantoroso.rf.gd", layout = MainLayout.class)
@RouteAlias(value = "", layout = MainLayout.class)
public class HttpsharwinLantorosoRfGdView extends Main {

    public HttpsharwinLantorosoRfGdView() {
        addClassName("httpsharwin-lantoroso-rf-gd-view");
